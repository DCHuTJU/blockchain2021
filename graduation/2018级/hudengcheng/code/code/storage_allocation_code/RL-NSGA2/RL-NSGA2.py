...
from parameters.parameters import alpha, gama, epsilon
import random
...
for gen in range(1, toolbox.maxGen):
    ...
    toolbox.cxProb = crossover_probs[state_co]

    # toolbox.cxProb = state_co
    ...
    toolbox.mutateProb = mutation_probs[state_mu]
    # toolbox.mutateProb = state_mu
